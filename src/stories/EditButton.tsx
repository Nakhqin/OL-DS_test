...
export const EditButton = ({
  ...
  const themeClass = theme === 'dark' ? 'edit-button--dark' : 'edit-button--light';
  return (
    <div className={`edit-button ${themeClass} ${enabled ? 'edit-button--enabled' : 'edit-button--disabled'}`} {...props}>
      <button
        className="edit-button__circle"
        disabled={!enabled}
        onClick={onClick}
        aria-label="Create new content"
      >
        <div className="edit-button__icon">
          <div className="edit-button__icon-bounds"></div>
          <svg className="edit-button__icon-shape" width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
